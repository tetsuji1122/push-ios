...
@property (strong, nonatomic) IBOutlet UITextView *notification;
...
- (void) displayPushNotification {
    NSString *notification = [[NSUserDefaults standardUserDefaults] stringForKey:@"notification"];
    self.notification.text = notification?notification:@"N/A";
}
